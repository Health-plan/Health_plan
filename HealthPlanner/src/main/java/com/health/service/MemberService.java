...
public class MemberService   {
		...
		/*
		 * public String now() throws Exception { return memberMapper.now(); } // 로그인
		 * public MemberDTO memberLogin(MemberDTO memberDto) throws Exception { return
		 ...
		 * Exception { return memberMapper.memberModifyGET(mbr_id); }
		 * 
		 * // 회원정보 수정 public void memberModifyPOST(MemberDTO memberDto) throws Exception
